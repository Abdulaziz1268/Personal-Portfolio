...
export default function About() {
  return (
    <div
      className="flex flex-col items-center justify-center py-15 w-screen dark:bg-black dark:text-white transition-colors duration-500"
      id="about"
    >
      <div className="w-[50%] flex justify-center mb-10">
        <p className="text-[#1f2937] font-bold text-4xl">About Me</p>
      </div>
      <div className="w-[80%] lg:w-[50%] ">
        <p className="text-xl text-[#374151] mb-7 leading-relaxed text-justify">
        ...
        <p className="text-xl text-[#374151] mb-7 text-justify">
