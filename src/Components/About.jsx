...
export default function About() {
  return (
    <div
      className="flex flex-col items-center justify-center py-15 w-screen dark:bg-gray-900 dark:text-white transition-colors duration-800 ease-in-out"
      id="about"
    >
      ...
      <div className="w-[80%] lg:w-[50%]">
        <p className="text-xl text-gray-700 dark:text-gray-300 mb-7 leading-relaxed text-justify transition-colors duration-800 ease-in-out">
        ...
        <p className="text-xl text-gray-700 dark:text-gray-300 mb-7 text-justify transition-colors duration-800 ease-in-out">
